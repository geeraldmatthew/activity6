...
class TrainersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trainer" do
    assert_difference('Trainer.count') do
      post trainers_url, params: { trainer: { address: @trainer.address, email: @trainer.email, gender: @trainer.gender, height: @trainer.height, name: @trainer.name, weight: @trainer.weight } }
    end
  ...
  test "should update trainer" do
    patch trainer_url(@trainer), params: { trainer: { address: @trainer.address, email: @trainer.email, gender: @trainer.gender, height: @trainer.height, name: @trainer.name, weight: @trainer.weight } }
